...
Installation: 
	...
	In client/player init (initPlayerLocal.sqf)
		[] execVM "icons.sqf";
	or 
		[] execVM "scripts\icons.sqf";    (if in a folder called scripts in your mission directory.)
...
_QS_ST_iconShadowMap = 2;									// NUMBER. Icon Shadow on MAP. 0 = no shadow. 1 = shadow. 2 = outline. Must be 0, 1, or 2. Default 1.
_QS_ST_iconTextSize_Map = 0.05;								// NUMBER. Icon Text Size on MAP display. Default is 0.05.
_QS_ST_iconTextOffset = 'center';							// STRING. Icon Text Offset. Can be 'left' or 'center' or 'right'. Default is 'right'
_QS_ST_iconSize_Man = 1;									// NUMBER. Icon Size by Vehicle Type. Man/Units. Default = 22
